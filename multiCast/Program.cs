namespace assignment8ex1
{
    class Program
    {
       public delegate void SunDelegate();
        ...
        {
            SunDelegate s1 = new SunDelegate(HereComesTheSun.display);
            s1 += HereComesTheSun.chorus;
            s1 += HereComesTheSun.verse1;
            s1 += HereComesTheSun.chorus;
            s1 += HereComesTheSun.verse2;
            s1 += HereComesTheSun.chorus2;
            s1 += HereComesTheSun.verse3;
            s1 += HereComesTheSun.chorus;
            s1 += HereComesTheSun.chorus;
            s1 += HereComesTheSun.end;
